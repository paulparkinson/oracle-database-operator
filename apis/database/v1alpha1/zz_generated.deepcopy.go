...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatabaseMetricsDetils) DeepCopyInto(out *DatabaseMetricsDetils) {
	*out = *in
	if in.DbName != nil {
		in, out := &in.DbName, &out.DbName
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatabaseMetricsDetils.
func (in *DatabaseMetricsDetils) DeepCopy() *DatabaseMetricsDetils {
	if in == nil {
		return nil
	}
	out := new(DatabaseMetricsDetils)
	in.DeepCopyInto(out)
	return out
}
